...
namespace Entidades
{
    public class Clase
    {
        ...
        public Clase(Profesor profesor, Dias dias, Horario horario)
        {
        ...
        public string Ficha()
        {
            return "Materia dada: " + this.profesor.curso.ToString() + Environment.NewLine +
                "Docente: " + this.profesor.ToString() + Environment.NewLine +
